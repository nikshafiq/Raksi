    ...
    <layout-default>
        ...
        class="w-full bg-white font-philosopher">
            <div class="w-full flex flex-col md:flex-row pt-nav md:pt-nav-desktop bg-primary-50">
                <div class="w-full">
                    <img src="@/assets/img/product/hauri-ayangan/hauri-ayangan-001.png" alt="Hauri Ayangan with box side by side" class="max-w-full">
                </div>
                <div class="w-full">
                    <img src="@/assets/img/product/hauri-ayangan/hauri-ayangan-002.png" alt="Hauri Ayangan" class="max-w-full">
                </div>
                <div class="flex flex-col w-full items-center justify-center p-2">
                    ...
                    <div class="w-full text-center px-2">
                        <ra-button 
                            buttonUrl="https://vt.tiktok.com/ZS9eS7EaFGjCq-3Jx7y/"
                            type="primary" 
                            label="Buy Now"/>
                    </div>
                </div>
