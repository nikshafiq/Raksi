    ...
    <layout-default>
        ...
        class="w-full bg-white font-philosopher">
            <div class="w-full flex flex-col md:flex-row pt-nav md:pt-nav-desktop bg-primary-50">
                <div class="w-full">
                    <img src="@/assets/img/product/rahasia-perindu/rahasia-perindu-001.png" alt="Rahasia Perindu with box side by side" class="max-w-full">
                </div>
                <div class="w-full">
                    <img src="@/assets/img/product/rahasia-perindu/rahasia-perindu-002.png" alt="Rahasia Perindu" class="max-w-full">
                </div>
                <div class="flex flex-col w-full items-center justify-center p-2">
                    <div class="text-h2 md:text-h1 uppercase text-primary">Rahasia Perindu</div>
                    ...
                    <div class="w-full text-center px-2">
                        <ra-button 
                            buttonUrl="https://vt.tiktok.com/ZS9eS7grLgL3g-nazur/"
                            type="primary" 
                            label="Buy Now"/>
                    </div>
                </div>
