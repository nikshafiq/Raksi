    ...
    <layout-default>
        ...
        class="w-full bg-white font-philosopher">
            <div class="w-full flex flex-col md:flex-row pt-nav md:pt-nav-desktop bg-primary-50">
                <div class="w-full">
                    <img src="@/assets/img/product/ratna-sari/ratna-sari-001.png" alt="Rasian with box side by side" class="max-w-full">
                </div>
                <div class="w-full">
                    <img src="@/assets/img/product/ratna-sari/ratna-sari-002.png" alt="Rasian" class="max-w-full">
                </div>
                <div class="flex flex-col w-full items-center justify-center p-2">
                    <div class="text-h2 md:text-h1 uppercase text-primary">Ratna Sari</div>
                    <div class="textsm md:text-md">Parfum | 50ml</div>
                    <div class="text-h3 text-h1 text-primary">~</div>
                    <div class="text-lg font-bold mb-2">RM319.00</div>
                    <div class="w-full text-center px-2">
                        <ra-button 
                            buttonUrl="https://vt.tiktok.com/ZS9eS7HSJNRbY-n75iE/"
                            type="primary" 
                            label="Buy Now"/>
                    </div>
                </div>
